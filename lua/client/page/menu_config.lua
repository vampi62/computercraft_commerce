function page_menu_config()
	...
	table.insert(global_term_objet_select,{xmin = 12, xmax = 22, ymin = 7, ymax = 7, value={action="page",id=203}, back_color = 256})
	table.insert(global_term_objet_select,{xmin = 12, xmax = 22, ymin = 9, ymax = 9, value={action="page",id=205}, back_color = 256})
	table.insert(global_term_objet_select,{xmin = 12, xmax = 22, ymin = 11, ymax = 11, value={action="action",id="reboot"}, back_color = 256})
	table.insert(global_term_objet_select,{xmin = 12, xmax = 22, ymin = 13, ymax = 13, value={action="action",id="shutdown"}, back_color = 256})
	table.insert(global_term_objet_select,{xmin = 12, xmax = 22, ymin = 15, ymax = 15, value={action="page",id=204}, back_color = 256})
end