...
function switch_status_commande()
	...
	elseif global_liste[liste][j]["statut"] == "6" then
		if global_liste[liste][j]["expediteur"] ~= global_session["pseudo"] then
			...
			table.insert(global_term_objet_write,{x = 35, y = 17, text = "ouvrir un litige", back_color = 128, text_color = 1})
		end
	elseif global_liste[liste][j]["statut"] == "7" then
		if global_liste[liste][j]["expediteur"] ~= global_session["pseudo"] then
			table.insert(global_term_objet_select,{xmin = 38, xmax = 46, ymin = 15, ymax = 15, parametre={action="page",id=33,filtre={id={valeur=global_liste[liste][j]["id_offre"],type="egal"}}}, back_color = 128})
	...
	elseif tonumber(global_liste[liste][j]["statut"]) >= 20 then
		if global_liste[liste][j]["expediteur"] ~= global_session["pseudo"] then
			table.insert(global_term_objet_select,{xmin = 35, xmax = 40, ymin = 15, ymax = 15, parametre={action="page",id=54,filtre={id={valeur=global_liste[liste][j]["id"],type="egal"}}}, back_color = 128})
			table.insert(global_term_objet_write,{x = 35, y = 15, text = "litige", back_color = 128, text_color = 1})
		else
			table.insert(global_term_objet_select,{xmin = 35, xmax = 40, ymin = 15, ymax = 15, parametre={action="page",id=154,filtre={id={valeur=global_liste[liste][j]["id"],type="egal"}}}, back_color = 128})
			table.insert(global_term_objet_write,{x = 35, y = 15, text = "litige", back_color = 128, text_color = 1})
		end
	end
end