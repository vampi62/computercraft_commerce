function page_tableau_offre_client()
	...
	local colonne_liste = {{text="vendeur      ",champ="proprio",type="string"},{text="nom           ",champ="nom",type="string"},{text="prix  ",champ="prix",type="int"},{text="stock ",champ="nbr_dispo",type="int"}}
	...
	for j=1, #global_filtre_liste[liste] do
		...
		if y <= global_max_y_page and y > global_min_y_page then
			table.insert(global_term_objet_write,{x = 1, y = y, text = global_filtre_liste[liste][j]["proprio"], back_color = 32768, text_color = 1})
			table.insert(global_term_objet_write,{x = 16, y = y, text = global_filtre_liste[liste][j]["nom"], back_color = 32768, text_color = 1})
			table.insert(global_term_objet_write,{x = 32, y = y, text = convert_grand_nombre(global_filtre_liste[liste][j]["prix"]), back_color = 32768, text_color = 1})
			table.insert(global_term_objet_write,{x = 41, y = y, text = convert_grand_nombre(global_filtre_liste[liste][j]["nbr_dispo"]), back_color = 32768, text_color = 1})
			table.insert(global_term_objet_write,{x = 49, y = y, text = "X", back_color = 128, text_color = 1})
			table.insert(global_term_objet_select,{xmin = 48, xmax = 50, ymin = y, ymax = y, parametre={action="page",id=33,filtre={id={valeur=global_filtre_liste[liste][j]["id"],type="egal"}}}, back_color = 128})
