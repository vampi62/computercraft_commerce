function page_offre_commerce()
	...
	for j=1, #global_filtre_liste["offre"] do
		...
		if y <= global_max_y_page and y > global_min_y_page then
			...
			table.insert(global_term_objet_write,{x = 1, y = y, text = global_filtre_liste["offre"][j][8], back_color = 32768, text_color = 1})
			table.insert(global_term_objet_write,{x = 23, y = y, text = convert_grand_nombre(global_filtre_liste["offre"][j][4]), back_color = 32768, text_color = 1})
			table.insert(global_term_objet_write,{x = 32, y = y, text = convert_grand_nombre(global_filtre_liste["offre"][j][5]), back_color = 32768, text_color = 1})
			...
			table.insert(global_term_objet_select,{xmin = 45, xmax = 50, ymin = y, ymax = y, value={action="page",id=133,value={id=global_filtre_liste["offre"][j][1]}}, back_color = 128})
