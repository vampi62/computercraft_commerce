...
function chargement_panier(liste)
	...
	for g=1, #global_filtre_liste[liste] do
		for j=1, #global_panier[global_session["pseudo"]] do
			if global_panier[global_session["pseudo"]][j]["id"] == global_filtre_liste[liste][g]["id"] then
				table.insert(global_filtre_liste["panier"],global_filtre_liste[liste][g])
				global_filtre_liste["panier"][#global_filtre_liste["panier"]]["quant"] = tonumber(global_panier[global_session["pseudo"]][j]["quant"])
				global_filtre_liste["panier"][#global_filtre_liste["panier"]]["prixg"] = global_panier[global_session["pseudo"]][j]["quant"]*global_filtre_liste[liste][g]["prix"]
