function page_filtres(type_page)
    ...
    table.insert(global_objet_select,{xmin = 38, xmax = 51, ymin = 17, ymax = 17, name = "retire_filtre", back_color = 256})
    table.insert(global_objet_write,{x = 15, y = 15, text = "valider les filtres", back_color = 256, text_color = 1})
    table.insert(global_objet_select,{xmin = 15, xmax = 33, ymin = 15, ymax = 15, name = "valide_filtre", back_color = 256})
end