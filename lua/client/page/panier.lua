function page_panier()
	...
	for j=1, #global_panier do
		...
		if y <= global_max_y_page and y >= global_min_y_page then
			...
			table.insert(global_objet_select,{xmin = 48, xmax = 50, ymin = y, ymax = y, name = "panier", value = j, back_color = 256}) -- bouton select
	...
	table.insert(global_objet_write,{x = 25, y = 3, text = "tous retirer", back_color = 256, text_color = 1})
	table.insert(global_objet_select,{xmin = 25, xmax = 38, ymin = 3, ymax = 3, name = "vide_panier", back_color = 256})
