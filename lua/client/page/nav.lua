function page_nav()
	...
	table.insert(global_term_objet_write,{x = 33, y = 1, text = "adresse", back_color = 256, text_color = 1})
	...
	table.insert(global_term_objet_write,{x = 33, y = 2, text = global_session["defautadresse"]["nom"], back_color = 256, text_color = 1})
	...
	if global_page_visible == 10 then
		table.insert(global_term_objet_select,{xmin = 1, xmax = 12, ymin = 19, ymax = 19, value={action="page",id=200}, back_color = 256})
		table.insert(global_term_objet_write,{x = 1, y = 19, text = "config poste", back_color = 256, text_color = 1})
	else
		table.insert(global_term_objet_select,{xmin = 1, xmax = 12, ymin = 19, ymax = 19, value={action="page",id=-1}, back_color = 256})
	...
	if global_session["pseudo"] ~= "" and global_session["mdp"] ~= "" then
		table.insert(global_term_objet_select,{xmin = 33, xmax = 51, ymin = 1, ymax = 2, value={action="page",id=90,exe="http_adresse"}, back_color = 256})
	else
		table.insert(global_term_objet_select,{xmin = 33, xmax = 51, ymin = 1, ymax = 2, value={action="page",id=20}, back_color = 256})
	end
