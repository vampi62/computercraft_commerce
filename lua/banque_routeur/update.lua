...
if dns == nil then
	...
	files.writeLine("dns = 'http://__ip_ou_dns_serveur_banque__:__port_si_non_80__/lua/'")
	files.writeLine("--[[ retirer les commentaire sur le type de poste a installer ]]--")
	files.writeLine("-- poste = 'client'")
	files.writeLine("-- poste = 'commerce'")
	files.writeLine("-- poste = 'banque-terminal'")
	files.writeLine("-- poste = 'banque-routeur'")
	files.writeLine("-- poste = 'banque-admin'")
	files.close()
...
function update_affichage_console(suivre_bas)
	...
	term.write("mise a jour : " ..poste.." - version : 1.1")
