...
if(!Checkdroits::CheckArgs($_GET,array('useraction' => false,'mdp' => false, 'id' => false, 'typeoffre' => false))) {
...
if(!Checkdroits::CheckId($bddConnection, $_GET['id'], 'offre')) {
    return array('status_code' => 404, 'message' => 'L\'offre n\'existe pas.');
}
if(!Checkdroits::CheckId($bddConnection, $_GET['typeoffre'], 'type_offre')) {
    return array('status_code' => 404, 'message' => 'Le type n\'existe pas.');
}
Offres::setOffreType($bddConnection, $_GET['id'], $_GET['typeoffre']);