...
if(!Checkdroits::CheckArgs($_GET,array('useraction' => false,'mdp' => false, 'id' => false, 'stock' => true))) {
...
if ((!empty($_GET['stock']) && ($_GET['stock']) < 0)) {
    return array('status_code' => 400, 'message' => 'Le stock doit être positif.');
}
Offres::setOffreStock($bddConnection, $_GET['id'], $_GET['stock']);
