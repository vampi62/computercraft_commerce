...
if(!Checkdroits::CheckArgs($_GET,array('useraction' => false,'mdp' => false, 'id' => false, 'descriptionoffre' => true))) {
...
Offres::setOffreDescription($bddConnection, $_GET['id'], $_GET['descriptionoffre']);
