...
if(!Checkdroits::CheckArgs($_GET,array('useraction' => false,'mdp' => false, 'id' => false, 'compte' => true))) {
...
if(!Checkdroits::CheckId($bddConnection, $_GET['compte'], 'compte')) {
    return array('status_code' => 404, 'message' => 'Le compte n\'existe pas.');
}
Offres::setOffreCompte($bddConnection, $_GET['id'], $_GET['compte']);
