...
if (!Checkdroits::checkArgs($_GET,array('reserver' => true, 'id_joueur' => true, 'id_endertank' => false))) {
...
if ($_GET['reserver']) {
    ...
    Enderstorages::setEnderStorageChest($bddConnection,$_GET['id_endertank'],$_GET['id_joueur'],date('Y-m-d H:i:s'));
    return array('status_code' => 200, 'message' => 'L\'enderstoragetank a bien été reservé.');
} else {
    Enderstorages::setEnderStorageChest($bddConnection,$_GET['id_endertank'],null,null);
