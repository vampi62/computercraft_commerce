...
if(!Checkdroits::CheckArgs($_GET,array('useraction' => false,'mdp' => false, 'id' => false, 'idkeyapi' => false))) {
...
if(!Checkdroits::CheckId($bddConnection, $_GET['idkeyapi'], 'keyapi')) {
    return array('status_code' => 404, 'message' => 'La keyapi n\'existe pas.');
}
Groupes::deletekeyapi($bddConnection, $_GET['idkeyapi']);
