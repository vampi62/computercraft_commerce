...
if(!Checkdroits::CheckArgs($_GET,array('useradmin' => false,'mdpadmin' => false, 'id_groupe' => false, 'id_joueur' => false))) {
...
Groupes::deleteJoueur($bddConnection, $_GET['id_groupe'], $_GET['id_joueur']);
