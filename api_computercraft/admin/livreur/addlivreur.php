...
if(!Checkdroits::CheckArgs($_GET,array('useraction' => false,'mdp' => false, 'id' => false, 'idcompte' => false, 'idadresse' => false, 'nom' => false))) {
...
if(!Checkdroits::CheckId($bddConnection, $_GET['idcompte'], 'compte')) {
    return array('status_code' => 404, 'message' => 'Le compte n\'existe pas.');
}
if(!Checkdroits::CheckId($bddConnection, $_GET['idadresse'], 'adresse')) {
    return array('status_code' => 404, 'message' => 'L\'adresse n\'existe pas.');
}
Livreurs::addLivreur($bddConnection, $_GET['id'], $_GET['idcompte'], $_GET['idadresse'], $_GET['nom']);
