...
if(checkdroits::CheckArgs($_GET,array('useraction' => false,'mdp' => false, 'id' => false, 'coo' => false))) {
...
Commandes::setCommandeSuivi($bddConnection, $_GET['id'], $_GET['coo']);
Commandes::setCommandeStatus($bddConnection, $_GET['id'], $_GET['coo']);
