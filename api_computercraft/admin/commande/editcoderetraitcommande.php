...
if(!Checkdroits::CheckArgs($_GET,array('useraction' => false,'mdp' => false, 'id' => false, 'code_retrait' => false))) {
...
Commandes::setCommandeCodeRetrait($bddConnection, $_GET['id'], $_GET['code_retrait']);
