...
if(!Checkdroits::CheckArgsss($_GET,array('useraction' => false,'mdp' => false, 'id' => false))) {
...
if(!Checkdroits::CheckId($bddConnection, $_GET['id'], 'transaction')) {
    return array('status_code' => 404, 'message' => 'La transaction n\'existe pas.');
}
return array('status_code' => 200, 'message' => '', 'data' => Transaction::getTransactionById($bddConnection, $_GET['id']));