...
if(!Checkdroits::CheckArgs($_GET,array('useradmin' => false,'mdpadmin' => false, 'id_adresse' => false, 'id_type_adresse' => false))) {
...
Adresses::setAdresseType($bddConnection, $_GET['id_adresse'], $_GET['id_type_adresse']);
