...
if(checkdroits::CheckArgs($_GET,array('useraction' => false,'mdp' => false, 'id' => false, 'description' => false))) {
...
Adresses::setAdresseDescription($bddConnection, $_GET['id'], $_GET['description']);
