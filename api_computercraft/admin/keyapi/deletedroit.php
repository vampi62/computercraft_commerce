...
if(!Checkdroits::CheckArgs($_GET,array('useraction' => false,'mdp' => false, 'id' => false, 'iddroit' => false))) {
...
if(!Checkdroits::CheckId($bddConnection, $_GET['iddroit'], 'droit')) {
    return array('status_code' => 404, 'message' => 'Le droit n\'existe pas.');
}
Keyapis::deleteDroitKeyapi($bddConnection, $_GET['id'], $_GET['iddroit']);
