...
if (!Checkdroits::checkArgs($_GET,array('page' => false, 'nbParPage' => false))) {
...
return array('status_code' => 200, 'message' => '', 'data' => Wirelessredstones::getWirelessRedstonesNonReserver($bddConnection,$_GET['page'],$_GET['nbParPage']));