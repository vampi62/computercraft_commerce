...
if (!Checkdroits::checkArgs($_GET,array('id_endertank' => false, 'show' => true))) {
...
return array('status_code' => 200, 'message' => '', 'data' => Enderstorages::getEnderStorageTankById($bddConnection,$_GET['id_endertank'], $_GET['show']));