...
if (!Checkdroits::checkArgs($_POST,array('reserver' => true, 'id_joueur' => true, 'id_enderstoragestank' => false), true)) {
...
if ($_POST['reserver']) {
    ...
    Enderstorages::setEnderStorageTank($bddConnection,$_POST['id_enderstoragestank'],$_POST['id_joueur'],date('Y-m-d H:i:s'));
