...
if (!Checkdroits::checkArgs($_POST,array('reserver' => true, 'id_joueur' => true, 'id_enderstorageschest' => false), true)) {
...
if (!Checkdroits::checkId($bddConnection, $_POST['id_enderstorageschest'], 'enderstorage_tank')) {
...
if ($_POST['reserver']) {
    ...
    Enderstorages::setEnderStorageChest($bddConnection,$_POST['id_enderstorageschest'],$_POST['id_joueur'],date('Y-m-d H:i:s'));
