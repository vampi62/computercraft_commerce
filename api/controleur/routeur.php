...
switch ($_SERVER['REQUEST_METHOD']) {
    case 'GET':
        ...
        //getgroupesbyjoueur                -> GET /groupes/joueur
        ...
        $router->add('/api/adresses', ['controller' => 'adresse', 'action' => 'getadresses']);
        $router->add('/api/adresses/groupe/{id_groupe:\d+}', ['controller' => 'adresse', 'action' => 'getadressesbygroupe']);
        $router->add('/api/apikey/{id_apikey:\d+}', ['controller' => 'apikey', 'action' => 'getapikeybyid']);
        $router->add('/api/apikeys', ['controller' => 'apikey', 'action' => 'getapikeys']);
        $router->add('/api/apikeys/groupe/{id_groupe:\d+}', ['controller' => 'apikey', 'action' => 'getapikeysbygroupe']);
        ...
        $router->add('/api/commandes/nolivreur', ['controller' => 'commande', 'action' => 'getcommandesnolivreur']);
        ...
        $router->add('/api/comptes', ['controller' => 'compte', 'action' => 'getcomptes']);
        $router->add('/api/comptes/groupe/{id_groupe:\d+}', ['controller' => 'compte', 'action' => 'getcomptesbygroupe']);
        ...
        $router->add('/api/enderstorageschest/joueur', ['controller' => 'enderstorageschest', 'action' => 'getenderstorageschestbyjoueur']);
        ...
        $router->add('/api/enderstoragestank/joueur', ['controller' => 'enderstoragestank', 'action' => 'getenderstoragestankbyjoueur']);
        ...
        $router->add('/api/groupes/joueur', ['controller' => 'groupe', 'action' => 'getgroupesbyjoueur']);
        ...
        $router->add('/api/livreurs', ['controller' => 'livreur', 'action' => 'getlivreurs']);
        ...
        $router->add('/api/livreurs/groupe/{id_groupe:\d+}', ['controller' => 'livreur', 'action' => 'getlivreursbygroupe']);
        ...
        $router->add('/api/offres/all', ['controller' => 'offre', 'action' => 'getoffresall']);
        ...
        $router->add('/api/offres/groupe/{id_groupe:\d+}', ['controller' => 'offre', 'action' => 'getoffresbygroupe']);
        $router->add('/api/transactions/compte/{id_compte:\d+}', ['controller' => 'transaction', 'action' => 'gettransactionsbycompte']);
        $router->add('/api/transactions/compte/{id_compte:\d+}/commande/{id_commande:\d+}', ['controller' => 'transaction', 'action' => 'gettransactionsbycomptecommande']);
        ...
        $router->add('/api/wireless/joueur', ['controller' => 'wireless', 'action' => 'getwirelessbyjoueur']);
    ...
    case 'POST':
        ...
        $router->add('/api/keypay', ['controller' => 'keypay', 'action' => 'addkeypay']);
    ...
    case 'PUT':
        ...
        $router->add('/api/joueur/recupmdpbyemail', ['controller' => 'joueur', 'action' => 'editjoueurrecupmdpbyemail']);
        $router->add('/api/joueur/recupmdpbyemailtoken', ['controller' => 'joueur', 'action' => 'editjoueurrecupmdpbyemailtoken']);
...
if ($resultEND[1] == '') {
    ...
    $endpoint = 'controleur' . $resultEND[1];
